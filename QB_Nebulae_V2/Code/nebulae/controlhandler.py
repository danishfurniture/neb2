...
class ControlHandler(object):
	...
	## Begin setting the max number of choices available using the 'altfile' control ('source' + 'file')(also called 'next' in some Qu-Bit code) (danishfurniture)
	...
	## End setting the max number of choices available using the 'altfile' control ('source' + 'file')(also called 'next' in some Qu-Bit code) (danishfurniture)
    ...
    def updateAll(self):
        ...
        if self.control_mode == "secondary controls":
            if self.prev_control_mode == "puredata":
                ...
                if self.configData is not None:
					if "SetFileIncrementOrder" in self.configData:
            ...
            if self.configData is not None:
				if "FreezeAltIgnoreSource" in self.configData:
            ...
            for chn in self.channels:
                ...
                if self.configData is not None:
	                if "SetGetStaticFileIdx" in self.configData:
